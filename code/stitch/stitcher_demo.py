...
if __name__ == "__main__":
    ...
    parser.add_argument('--demo', default='exp1', help='exp1, exp2, exp3, exp4')
    parser.add_argument('--root', default='/home/fsh/stitching_and_registration/input_data/demo_stitch')
    parser.add_argument('--outfile', default='/home/fsh/stitching_and_registration/output_data/demo_stitch')
    ...
    total = 0
    success = 0
    image_dir = sorted(glob(osp.join(osp.join(root, demo), '*')))
    print(image_dir)
    out_path = osp.join(out_root, demo)
    ...
    image_name = demo + '_' + match_method + '_' + str(len(image_list)) + '.jpg'
    print(homo_list)
