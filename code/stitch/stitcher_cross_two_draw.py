...
if __name__ == "__main__":
    ...
    for i in draw_list:
        ...
        out_path_match = out_path + '/match' + match_method + '_' + str(i) + '_' + str(len(image_list)) + '.jpg'
        print(out_path)
        ...
        if status == cv2.Stitcher_OK:
            ...
            out_path_merge = out_path + '/merge' + match_method + '_' + str(i) + '_' + str(len(image_list)) + '.jpg'
